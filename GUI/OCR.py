...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_file = QtWidgets.QPushButton(self.widget_13)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.pushButton_file.setStyleSheet("color: rgb(255, 255, 255);\n"
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.pushButton_file)
        ...
        self.pushButton_start = QtWidgets.QPushButton(self.widget_13)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(20)
        font.setBold(True)
...
"")
        ...
        self.label_img = QtWidgets.QLabel(self.widget_9)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.verticalLayout_6.addWidget(self.label_img)
        ...
        self.label_img_8 = QtWidgets.QLabel(self.widget_11)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.horizontalLayout.addWidget(self.label_img_8)
        self.horizontalLayout.setStretch(0, 5)
        self.horizontalLayout.setStretch(1, 5)
        self.horizontalLayout.setStretch(2, 1)
        self.verticalLayout_7.addWidget(self.widget_11)
        self.label_img_6 = QtWidgets.QLabel(self.widget_10)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.verticalLayout_7.addWidget(self.label_img_6)
        ...
        self.pushButton_run = QtWidgets.QPushButton(self.widget_5)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
...
"")
        ...
        self.label_img_4 = QtWidgets.QLabel(self.widget_6)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.horizontalLayout_3.addWidget(self.label_img_4)
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem4)
        self.pushButton_run_2 = QtWidgets.QPushButton(self.widget_6)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_run_2.setFont(font)
        self.pushButton_run_2.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(85, 85, 255);\n"
"border-radius: 12px;  \n"
"border: 2px groove gray;\n"
"border-style: outset;\n"
"")
        ...
        self.horizontalLayout_3.addWidget(self.pushButton_run_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_file.setText(_translate("MainWindow", "导入视频"))
        ...
        self.label_img.setText(_translate("MainWindow", "屏幕截图界面"))
        self.label_img_5.setText(_translate("MainWindow", "弹窗提示"))
        self.label_img_8.setText(_translate("MainWindow", "00:00:00"))
        self.label_img_6.setText(_translate("MainWindow", "弹窗截图界面"))
        ...
        self.pushButton_run_2.setText(_translate("MainWindow", "导出结果"))
